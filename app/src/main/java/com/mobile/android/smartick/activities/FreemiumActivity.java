  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    avatarAgeSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
      public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        if (avatarPreviewWidth == 0) {
          avatarPreviewHeight = selectedAvatarPreview.getLayoutParams().height;
          avatarPreviewWidth = selectedAvatarPreview.getLayoutParams().width;
        }
...
//        Log.d(Constants.FREEMIUM_LOG_TAG,"Avatar selected " + v.getTag());
    ...
    switch (Integer.parseInt((String) v.getTag())) {
      case 1:
        bigAvatarId = R.drawable.avatar1_big;
        break;
      case 2:
        bigAvatarId = R.drawable.avatar2_big;
        break;
      case 3:
        bigAvatarId = R.drawable.avatar3_big;
        break;
      case 4:
        bigAvatarId = R.drawable.avatar4_big;
        break;
      case 5:
        bigAvatarId = R.drawable.avatar5_big;
        break;
      case 6:
        bigAvatarId = R.drawable.avatar6_big;
        break;
      case 7:
        bigAvatarId = R.drawable.avatar7_big;
        break;
      case 8:
        bigAvatarId = R.drawable.avatar8_big;
        break;
      case 9:
        bigAvatarId = R.drawable.avatar9_big;
        break;
      default:
        bigAvatarId = R.drawable.avatar1_big;
    }
