...
import com.smartick.util.Network;
import com.smartick.widgets.adapters.UsersListAdapter;
...
public class LoginActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Comprobacion de id de instalacion unico
        ...
        // se crea un fichero de texto y se guarda su path en preferencias de la app
        ...
        if (devInfoFileName == null){
            // crea fichero con datos
            Context context = this.getApplicationContext();
            String path = DeviceInfo.createDeviceInfoFile(context);

            // almacena nombre de fichero en preferencias
    ...
    private String doHttpPost(String url){
        ...
        post.addHeader("ipad-app", installationId);
        try {
